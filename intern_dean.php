                        ...
                        <table id="myTable" class="tablesorter">
                        	<thead>
							    ...
							    <tr>
                                    ...
                                    <th style="width:12%">Internship Type</th>
                                <th style="width:10%">Stipened</th>
                            ...
                            <tbody>
							        <?php 
		$ps=mysql_query("select * from intern order by id desc");	
		while($pst= mysql_fetch_array($ps)){
						?>
                                <tr>
                          <td class="align-center"><?php echo $pst['id']?></td>
                                   <td><?php echo $pst['company']?></a></td>
                                    <td><?php echo $pst['type']?></td>
                                    <td><?php echo $pst['stipened']?></td>
                                    <td><?php echo $pst['date']?></td>
                                    <td><?php echo $pst['vacancies']?></a></td>
								    <td><?php echo $pst['remarks']?></td>
                        <td><a href="<?php echo $pst['docs']?>">document</a></td>
                                   <td>    <a href=""><img src="minus-circle.gif" tppabs="http://www.xooom.pl/work/magicadmin/images/tick-circle.gif" width="16" height="16" alt="published" /></a>
